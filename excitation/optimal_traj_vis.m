...
% load('./data/opt_x.txt');
% load('data/No1_excitation_trajectory_parameters_0-30-0-60-0-90-0.mat');    
% load('data/No2_excitation_trajectory_parameters_0-30-0-60-0-270-0.mat');
% load('data/No3_excitation_trajectory_parameters_0-330-0-60-0-0-0.mat');
% load('data/No4_excitation_trajectory_parameters_0-0-0-60-0-30-0.mat');
load('data/No5_excitation_trajectory_parameters_0-0-0-30-0-60-0.mat');
...
% title('激励轨迹关节角加速度曲线'); 
xlabel('时间(s)'); ylabel('关节角加速度(rad/s^2)');
legend('关节1', '关节2', '关节3', '关节4', '关节5', '关节6', '关节7');
